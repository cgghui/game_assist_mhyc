...
func TestDeBinaryCode(t *testing.T) {
	code, err := base64.StdEncoding.DecodeString("B3UrGwix5AMQARgA") //EWFnIQiluQI=
	if err != nil {
		t.Error(err)
	}
	var ma = &C2SActXunBaoDraw{}
...
func TestDeBinaryCode2(t *testing.T) {
	code, err := base64.StdEncoding.DecodeString("AVUCvwgGEAEYLA==") //EWFnIQiluQI=
	if err != nil {
		t.Error(err)
	}
	var ma = &C2SGetTaskPrize{}
	if err = proto.Unmarshal(code[4:], ma); err != nil {
		t.Error(err)
	}
	// type:8 id:385
